...
df_plot2 <- df_test %>% pivot_longer(cols= danceability:tempo, names_to = "features", values_to = "score") %>% mutate(features = str_to_title(features), album_name = str_to_title(album_name))
...
ggplot(df_plot2, aes(x = album_name, y = score, color = album_name)) +
  ...
  theme_minimal() +
  labs(title = "Characteristics of Taylor's Top and Bottom 2 Albums Based on User Scores", 
      x = "", 
      y = "Score", 
      color = "Album")
